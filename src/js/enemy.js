	...
	init(){
		...
		switch(this.type) {
			...
			case this.Enemy_Type_Large: 
				...
				this.dieImgs = ["imgs/plane3_die1.png", "imgs/plane3_die2.png", "imgs/plane3_die3.png", "imgs/plane3_die4.png", "imgs/plane3_die5.png", "imgs/plane3_die6.png"];
				this.score = 30; 
				break;
			...
			case this.Enemy_Type_Middle: 
				...
				this.dieImgs = ["imgs/plane2_die1.png", "imgs/plane2_die2.png", "imgs/plane2_die3.png", "imgs/plane2_die4.png"];
				this.score = 20; 
				break;
			...
			case this.Enemy_Type_Small: 
				...
				this.dieImgs = ["imgs/plane1_die1.png", "imgs/plane1_die2.png", "imgs/plane1_die3.png"];
				this.score = 10; 
				break;
